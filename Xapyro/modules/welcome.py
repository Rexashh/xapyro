...
async def welcome(client, message):
    await xapyrodb.clear_welcome(str(message.chat.id))
...
async def new_welcome(client, message):
    msg_id = await xapyrodb.get_welcome(str(message.chat.id))
    caption = ""
    men = ""
...
async def setwelcome(client, message):
    ...
    await xapyrodb.save_welcome(str(message.chat.id), msg_id)
